...
/**
 * GENDER LABEL auf Produktseiten anzeigen, wenn das Produkt in Damen- oder Herren-Kategorie ist.
 */

add_shortcode('jg_archive_gender_label', function () {
    ...
    foreach ($term_ids as $term_id) {
        ...
        if ($category->slug === 'damen') {
            return '<div class="jg-archive-gender-label">DAMEN</div>';
        }

        if ($category->slug === 'herren') {
            return '<div class="jg-archive-gender-label">HERREN</div>';
        }
    }
